...
e:{c:d+(a.colspan-1),r:c+(a.rowspan-1)}})})}),b},/**
         ...
         * @returns {*}
         */
this.getFileExtension=function(b,c){if(!_.includes(_.values(a.supported_file_types),c))throw new Error(this.MESSAGE_UNSUPPORTED_FILE_MIMETYPE);var d=_.findKey(a.supported_file_types,function(a){return a===c});
// windows always sends csv as the same mime type of xls
// windows always sends csv as the same mime type of xls
return navigator.platform.indexOf("Win")!==-1&&"csv"===b&&"xls"===d?b:d},/**
         * getFileMimeType
         *
         * @param file_extension
         * @returns {*}
